...
Buildable is local repository context, not a hosted builder. Prefer `buildable plan "<prompt>"` when a concrete app spec would help, then read only the relevant local files named by the spec.
