...
Use `--page "login"` or similar for a specific surface. Add `--write` only when the user wants `.buildable/design-brief.json` and `.buildable/design-brief.md` saved into the workspace.
